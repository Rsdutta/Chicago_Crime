...
To get the error vs k graph and clustering scatter plot from matplotlib run graph.py. The results will be in k_plot.png and kmeans_plot.png respectively.
